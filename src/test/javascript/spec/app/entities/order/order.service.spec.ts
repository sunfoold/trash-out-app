        ...
        const returnedFromService = Object.assign(
          {
            ...
            orderStartDate: currentDate.format(DATE_TIME_FORMAT),
            orderFinishDate: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
        ...
        const returnedFromService = Object.assign(
          {
            ...
            finishDate: currentDate.format(DATE_TIME_FORMAT),
            userPhotoUrl: 'BBBBBB',
            courierPhotoUrl: 'BBBBBB',
            endOrderPhotoUrl: 'BBBBBB',
            orderStartDate: currentDate.format(DATE_TIME_FORMAT),
            orderFinishDate: currentDate.format(DATE_TIME_FORMAT),
            orderStatus: 'BBBBBB',
            courierRatio: 1,
